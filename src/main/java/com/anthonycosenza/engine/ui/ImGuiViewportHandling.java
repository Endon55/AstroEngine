...
public class ImGuiViewportHandling
{
    ...
    /**
     * Method to do an initialization of the {@link ImGuiViewportHandling} state. It SHOULD be called before calling the {@link ImGuiViewportHandling#newFrame()} method.
     * <p>
    ...
    /**
     * Method to restore {@link org.lwjgl.glfw.GLFW} to it's state prior to calling method {@link ImGuiViewportHandling#init(long, boolean)}.
     */
    public void clean()
    {
    ...
    private final class CreateWindowFunction extends ImPlatformFuncViewport
    {
        ...
        public void accept(final ImGuiViewport vp)
        {
            ...
            glfwSetMouseButtonCallback(data.window, ImGuiViewportHandling.this::mouseButtonCallback);
            glfwSetScrollCallback(data.window, ImGuiViewportHandling.this::scrollCallback);
            glfwSetKeyCallback(data.window, ImGuiViewportHandling.this::keyCallback);
            glfwSetCharCallback(data.window, ImGuiViewportHandling.this::charCallback);
            glfwSetWindowCloseCallback(data.window, ImGuiViewportHandling.this::windowCloseCallback);
            glfwSetWindowPosCallback(data.window, ImGuiViewportHandling.this::windowPosCallback);
            glfwSetWindowSizeCallback(data.window, ImGuiViewportHandling.this::windowSizeCallback);
